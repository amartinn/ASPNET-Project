...
namespace CasesNET.Web.Areas.Administration.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Orders.Include(o => o.Cart).Include(o => o.OrderedBy);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["OrderedById"] = new SelectList(_context.Users, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderedById,CartId,OrderStatus,Id,CreatedOn,ModifiedOn")] Order order)
        {
            ...
            ViewData["OrderedById"] = new SelectList(_context.Users, "Id", "Id", order.OrderedById);
            return View(order);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderedById,CartId,OrderStatus,Id,CreatedOn,ModifiedOn")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
